...
public class Car {
    ...
    public Boolean isRacingCar() {
        ...
        // else false
        return this.getTyre().isSlickTyre();
    }
    ...
    public String printDescription(){
        ...
        if(this.isRacingCar()){
        return String.format("Mobil balap ini memiliki %d roda dengan kapasitas mesin %d cc", this.getNumberOfWheels(), this.getEngine().getEngineCapacity());
        }
        else
        {
           return String.format("Mobil ini memiliki %d roda dengan kapasitas mesin %d cc", this.getNumberOfWheels(), this.getEngine().getEngineCapacity());
        }
    }
}
